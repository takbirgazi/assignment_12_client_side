...
const AddTest = () => {
    ...
    const onSubmit = async (data) => { 
        ...
        const testInfo = { testName: data.testName, testDetails: data.testDetails, testPrice: data.testPrice, testSlots: data.testSlots,testDate: data.testDate, testImage: res.data.data.display_url }
                            ...
                            <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                                ...
                                <div className="flex flex-col md:flex-row gap-2">                              
                                    ...
                                    <div className="form-control w-full">
                                            ...
                                            <input type="text" {...register("testSlots")} placeholder="Coupon2024" className="input input-bordered" required />
                                    </div>
                                </div>
                                <div className="flex flex-col md:flex-row gap-2"> 
                                    <div className="form-control w-full">
                                    ...
                                    <div className="form-control w-full">
                                            ...
                                            <input type="text" {...register("testDate")} placeholder="Coupon2024" className="input input-bordered" required />
                                    </div>
                                </div>
